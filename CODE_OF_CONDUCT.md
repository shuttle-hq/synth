...
[Synth moderators](mailto:mods@getsynth.com) immediately. Whether you’re a
...
[Synth moderators](mailto:mods@getsynth.com).

1. Remarks that violate the Synth standards of conduct, including hateful,
...
In the Synth community we strive to go the extra step to look out for each
...
responsibility to make your fellow synther comfortable. Everyone wants to
...
The enforcement policies listed above apply to all official Synth venues;
including [Discord channels](https://discord.gg/H33rRDTm3p) and
[GitHub repositories under getsynth](https://github.com/getsynth). For other
projects adopting the Synth Code of Conduct, please contact the maintainers of
