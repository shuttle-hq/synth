        ...
        <div className="grid gap-12 lg:gap-0 lg:grid-cols-2 pt-6 sm:pt-20 lg:pt-32 pb-6 sm:pb-20 lg:pb-32">
          <div className="lg:w-5/6">
            ...
            <div className="text-xl pb-5 font-normal text-gray-200">
              Synth is an open source data-as-code tool that provides a simple
            ...
            <div className="pb-6">
              <AccentButton
                className="text-white font-bold bg-brand-600 hover:bg-brand-400 p-3"
                link="/docs/"
              >
                READ THE DOCS
              </AccentButton>
          ...
          <img
            src={`${basePath}/images/synth-small-window.svg`}
            className="m-auto w-"
          />
        </div>
      </div>
