    ...
    <Section id="privacy-policy" style="bg-gray-600" title="Privacy Policy">
      <div className="grid lg:grid-cols-1">
        <div className="my-auto gap-10 text-lg">
          ...
          <br />
          Welcome to OpenQuery Ltd..
          <br /> <br />
          OpenQuery Ltd. (“us”, “we”, or “our”) operates http://getsynth.com
          (hereinafter referred to as “Service”).
          <br /> <br />
          Our Privacy Policy governs your visit to http://getsynth.com, and
          explains how we collect, safeguard and disclose information that
          results from your use of our Service. <br /> <br />
          ...
          <br />
          <strong>SERVICE</strong> means the http://getsynth.com website
          operated by OpenQuery Ltd..
          <br /> <br />
          ...
          <br />
          OpenQuery Ltd. uses the collected data for various purposes:
          <br /> <br />
          ...
          <br /> <br />
          (m) for any other purpose with your consent. <br /> <br />
          <strong>
            6. Retention of Data
            <br />
          </strong>{" "}
          ...
          <br /> <br />
          OpenQuery Ltd. will take all the steps reasonably necessary to ensure
          ...
          <br /> <br /> (i) to our subsidiaries and affiliates;
          <br /> <br />
          (ii) to contractors, service providers, and other third parties we use
          to support our business;
          <br />
          <br /> (iii) to fulfill the purpose for which you provide it;
          <br /> <br /> (iv) for the purpose of including your company’s logo on
          our website;
          <br /> <br /> (v) for any other purpose disclosed by us when you
          provide the information;
          <br /> <br /> (vi) with your consent in any other cases;
          <br /> <br />
          ...
          – See more at https://eur-lex.europa.eu/eli/reg/2016/679/oj <br />{" "}
          <br />
          ...
          websites that you do not want to be tracked. <br /> <br />
          ...
          <br /> <br /> (i) The categories of personal information we have
          collected about you.
          <br /> <br /> (ii) The categories of sources from which we collect
          your personal information.
          <br /> <br /> (iii) The business or commercial purpose for collecting
          or selling your personal information.
          <br /> <br /> (iv) The categories of third parties with whom we share
          personal information.
          <br /> <br /> (v) The specific pieces of personal information we have
          collected about you.
          <br /> <br /> (vi) A list of categories of personal information that
          we have sold, along with the category of any other company we sold it
          to. If we have not sold your personal information, we will inform you
          of that fact.
          <br /> <br /> (vii) A list of categories of personal information that
          we have disclosed for a business purpose, along with the category of
          ...
          <br /> <br />
          (b) To delete your personal information. If you make this request, we
          ...
          that require your personal information to operate. <br /> <br />
          ...
          My Personal Information” at the bottom of our home page to submit your
          request.
          <br /> <br />
          ...
          <br /> <br />
          By visiting this page on our website: http://getsynth.com/contact
          <br /> <br />
          ...
          Fathom Analytics
          <br />
          Fathom Analytics is analytics service provided by Conva Ventures Inc.
          You can find their Privacy Policy here: https://usefathom.com/privacy/
          <br /> <br />
          <strong>
            15. CI/CD tools
            <br />
          ...
          heir Privacy Policy can be viewed at: https://stripe.com/us/privacy
          <br /> <br />
          <strong>
