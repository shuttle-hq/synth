      ...
      <div className="grid lg:grid-cols-1 ">
        <div className="my-auto gap-10 text-lg">
          <div className="text-block-6">
            ...
            Welcome to OpenQuery Ltd. (“Company”, “we”, “our”, “us”)! As you
            ...
            of our web pages located at http://www.getsynth.com operated by
            OpenQuery Ltd.
            <br /> <br />
            ...
            <a href="http://www.getsynth.com/privacy">here</a>.<br /> <br />
            ...
            info@getsynth.com so we can try to find a solution. These Terms
            ...
            unauthorized or illegal transaction is suspected. <br /> <br />
            <strong>
              {" "}
            ...
            cancel it or OpenQuery Ltd. cancels it. You may cancel your
            Subscription renewal either through your online account management
            page or by contacting OpenQuery Ltd. customer support team.
            <br /> <br />A valid payment method, including credit card or
            PayPal, is required to process the payment for your subscription.
            You shall provide OpenQuery Ltd. with accurate and complete billing
            ...
            payment information, you automatically authorize OpenQuery Ltd. to
            charge all Subscription fees incurred through your account to any
            such payment instruments.
            <br /> <br />
            Should automatic billing fail to occur for any reason, OpenQuery
            Ltd. will issue an electronic invoice indicating that you must
            ...
            OpenQuery Ltd. may, at its sole discretion, offer a Subscription
            ...
            Trial, you will not be charged by OpenQuery Ltd. until Free Trial
            ...
            selected.
            <br /> <br />
            At any time and without notice, OpenQuery Ltd. reserves the right to
            ...
            OpenQuery Ltd., in its sole discretion and at any time, may modify
            ...
            <br /> <br />
            OpenQuery Ltd. will provide you with a reasonable prior notice of
            ...
            OpenQuery Ltd. or used with permission. You may not distribute,
            ...
            <br /> <br /> (f) To engage in any other conduct that restricts or
            ...
            <br /> <br /> (a) Use Service in any manner that could disable,
            ...
            Service.
            <br /> <br /> (g) Attack Service via a denial-of-service attack or a
            distributed denial-of-service attack.
            <br /> <br /> (h) Take any action that may damage or falsify Company
            rating.
            <br /> <br /> (i) Otherwise attempt to interfere with the proper
            working of Service.
            <br />
            <br />
            <strong>
            ...
            Inc. You can find their Privacy Policy{" "}
            <a href="https://usefathom.com/privacy/">here</a>.<br /> <br />{" "}
            <br />
            <strong>
              {" "}
              12. No Use By Minors
            ...
            property of OpenQuery Ltd. and its licensors. Service is protected
            ...
            email to legal@openquery.io, with the subject line: “Copyright
            ...
            detail):
            <br /> <br /> (a) an electronic or physical signature of the person
            authorized to act on behalf of the owner of the copyright&#x27;s
            interest;
            <br /> <br /> (b) a description of the copyrighted work that you
            claim has been infringed, including the URL (i.e., web page address)
            of the location where the copyrighted work exists or a copy of the
            copyrighted work;
            <br />
            <br /> (c) identification of the URL or other specific location on
            Service where the material that you claim is infringing is located;
            <br /> <br /> (d) your address, telephone number, and email address;
            <br /> <br /> (e) a statement by you that you have a good faith
            belief that the disputed use is not authorized by the copyright
            owner, its agent, or the law;
            <br /> <br /> (f) a statement by you, made under penalty of perjury,
            ...
            owner&#x27;s behalf.
            <br /> <br />
            You can contact our Copyright Agent via email at legal@openquery.io
            <br /> <br />
            <strong>
              {" "}
            ...
            You may provide us either directly at info@getsynth.com or via third
            ...
            Software Inc. More information is available{" "}
            <a href="https://sentry.io/privacy/">here</a>. <br />
            <br />
            <strong>
              {" "}
            ...
            that are not owned or controlled by OpenQuery Ltd.
            <br /> <br />
            OpenQuery Ltd. has no control over, and assumes no responsibility
            for the content, privacy policies, or practices of any third party
            web sites or services. We do not warrant the offerings of any of
            these entities/individuals or their websites.
            <br /> <br />
            YOU ACKNOWLEDGE AND AGREE THAT OpenQuery Ltd. SHALL NOT BE
            ...
            <br />
            By email: info@getsynth.com.
            <br />
            By visiting this page on our website:
            http://www.getsynth.com/contact.
          </div>
        </div>
      </div>
    </Section>
