...
const install_code = `curl -sSL ${SITE_URL}install | sh`
          ...
          <div className="lg:w-5/6">
            <div className="leading-none overflow-visible font-semibold text-6xl pb-5">
              <span className="block">
                Download <span className="text-brand-400">Synth</span>
              </span>
            </div>
            <div className="text-xl pb-5 font-normal text-gray-200">
              Synth is being improved constantly on the quest to build the{" "}
              <span className="font-medium">
                best data generator in the world
              </span>
              .
            </div>
...
function DownloadContact() {
  ...
  if (state.succeeded) {
    return (
      <div>Thank you for getting in touch! We'll get back to you shortly.</div>
    )
  }
  return (
    <form
      className="container w-10/12 xl:w-5/12 xl:px-12 py-5 mx-auto"
      onSubmit={handleSubmit}
    >
      <div className="leading-none overflow-visible pb-5">
        <span className="block font-medium pb-5 text-6xl">
          Need some help getting started?
        </span>
        <span className="text-xl text-gray-300">
          Leave us your info and we'll get in touch.
        </span>
      </div>
...
function DownloadButton() {
  ...
  return (
    <div suppressHydrationWarning>
      {ua.isWindows ? (
        <div className="pb-6 md:flex mx-auto">
          <AccentButton link={windows_install_link}>
            <FontAwesomeIcon className="h-5 pr-2" icon={faWindows} /> Download
            Synth
          </AccentButton>
        </div>
      ) : (
      ...
      <div className="text-xl pb-5 font-normal text-gray-400">
        Synth is distributed as a single binary. To download older versions of
        synth check out our{" "}
        <a
          className="text-brand-400"
          href="https://github.com/getsynth/synth/releases"
        >
          releases
        </a>{" "}
        on GitHub.
      ...
      <div className="text-sm font-medium text-gray-400">
        ...
        <a className="text-brand-400" href="docs/getting_started/installation">
          &nbsp;other&nbsp;
        </a>
